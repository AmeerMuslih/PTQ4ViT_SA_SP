...
def matmul_sa(tensor_a, tensor_b):
	...
	# torch.save(InputA_TOT, f'/home/a.mosa/Ameer/PTQ4ViT_Firas/OutputFiles/Group_{start_idx}/InputA_TOT.pt')
	# torch.save(InputB_TOT, f'/home/a.mosa/Ameer/PTQ4ViT_Firas/OutputFiles/Group_{start_idx}/InputB_TOT.pt')
	#print("Cycles = ", cycles)
	#print(dut.shape)
	return dut